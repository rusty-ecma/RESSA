...
fn update_with_expr<'a>(expr: &Expr<'a>, set: &mut HashSet<Cow<'a, str>>) -> Result<(), Cow<'a, str>> {
...
fn update_with_prop<'a>(prop: &Prop<'a>, set: &mut HashSet<Cow<'a, str>>) -> Result<(), Cow<'a, str>> {
